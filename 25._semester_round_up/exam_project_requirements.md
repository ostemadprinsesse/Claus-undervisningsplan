...
The theory can be found in slides and in part 1 of the DevOps Handbook. 
...
Though there are truths - like the Weekly DevOps Principles, we have touched during this semester - many supporting definitions and some conflicting exist. I cannot provide a single definition that you must memorize. And even if I could, it wouldn't be interesting to me.
...
Your application must be deployed to a Virtual Machine(s). Services like Web Apps or Azure Azure Database for PostgreSQL or MySql etc. are great and easy to use, but it removes your chance to learn about topics such as server management, maintenance and upkeep.
...
Your system must be deployed for the whole exam period.

---

# Other Requirements

You must have all your group data filled out in the `groups.py` file. 
...
While the general content of the semester materials are  mandatory knowledge, sources and external links (included in the slides) are not required reading unless explicitly mentioned in the semester plan / materials.
