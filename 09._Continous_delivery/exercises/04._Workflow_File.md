...
In [.github/workflows/continous_delivery.yml](https://github.com/cookbookio/awsome_recipe_cookbook/blob/cd/.github/workflows/continuous_delivery.yml) you will find the workflow that builds and pushes the images to the Github Container Registry.
...
```yaml
    image: ghcr.io/cookbookio/awsome_recipe_cookbook:latest
```
