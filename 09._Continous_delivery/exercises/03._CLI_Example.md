...
```bash
$ docker-compose -f docker-compose.prod.yml build awsome_recipe_flask
$ docker push ghcr.io/cookbookio/awsome_recipe_cookbook:latest
```
<!--
...
https://github.com/orgs/cookbookio/packages

If you have pushed your own images, then replace `cookbookio` with your own user / organisation name you published to.
...
Then go to the package under `https://github.com/orgs/cookbooio/packages`. Replace `cookbookio` with your own user / organisation name you published to.
