# Create a PR to groups.py

Add your group to [groups.py](/groups.py) which is in the root of the semester repository. 
...
2. Before next teachings you must fill the values for the following keys: 
...
- `members`: The Members of your group
...
```bash
$ python -m py_compile groups.py
```

4. **IMPORTANT** Get the latest changes. 

Just before you push your changes, make sure you have the latest changes from the original repository. See [Pulling from the Original Repository into your fork](#pulling-from-the-original-repository-into-your-fork) for more information.
