...
<img src="./assets/awsome_recipe_cookbook.png" alt="Awsome Recipe CookBook" style="height: 45vh;">
...
<img src="./assets/awsome_recipe_cookbook.png" alt="CookBook website screenshot">
...
Maybe not so useful but we can see that some python code is running.
