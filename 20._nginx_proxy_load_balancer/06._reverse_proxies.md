...
* **Load balancing**
![](assets_reverse_proxies/nginx_load_balancing.svg)

* **HTTP caching**
![](assets_reverse_proxies/nginx_http_caching.svg)
...
![](assets_reverse_proxies/nginx_security_tls_port_protection.svg)
...
* **Directives** have keys and values, which are seperated by whitespace, and the key value pairs are separated by semicolons.
...
Create a folder anywhere. I will create mine in the [Awsome recipe cookbook repository in a nginx branch](https://github.com/cookbookio/awsome_recipe_cookbook/tree/nginx).
...
https://github.com/cookbookio/awsome_recipe_cookbook/tree/proxy
...
# [The `nginx.conf` file](https://github.com/cookbookio/awsome_recipe_cookbook/blob/proxy/src/network/nginx.conf)
